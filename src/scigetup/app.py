...
Exec=/bin/bash -ic 'module load {app_name}; export PROMPT_COMMAND="echo -e \"=== {app_name} module is loaded === Run {executable} to start application ===\"; unset PROMPT_COMMAND"; exec bash'
Type=Application
Categories={app_name}
Terminal=true
"""
