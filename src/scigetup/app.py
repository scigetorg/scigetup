...
Exec=/bin/bash -ic 'module load {app_name}; export PROMPT_COMMAND="echo Module {app_name} is loaded. Run {executable} below to start application; unset PROMPT_COMMAND"; exec bash'
Type=Application
Categories={app_name}
Terminal=true
"""
